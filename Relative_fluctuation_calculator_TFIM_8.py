...
def main(args):
    ...
    # Convert to circuits of Gate objects
...
if __name__ == '__main__':
    ...
    # Add seed parameter for setting the random seed, default is 0
    parser.add_argument("--seed", type=int, default=1, help="Random seed.")
    # Metric information
    parser.add_argument("--proxy", type=str, default='RF', help="Proxy metric file name.")
    # Task type: TFIM
    parser.add_argument("--task", type=str, default='TFIM_8', help="Task name.")
    # Search space
    ...
    parser.add_argument("--sample_lines", type=int, default=50, help="Number of sampled circuits.")
